...
updateTask.onsubmit = function (e) {
  ...
  const task = new Task(editName, editDescription, editDueDate, editPriority, editComplete);
...
taskForm.onsubmit = function () {
  ...
  const projDrop = document.querySelector('#projectSelect').selectedOptions[0].value;
